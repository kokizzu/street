...
/**
 * @typedef {Object} AdminUserCrudIn
 * @property {String} action
 */
const AdminUserCrudIn = {
  action: '', // string
}
/**
 * @typedef {Object} AdminUserCrudOut
 * @property {Object} users
 */
const AdminUserCrudOut = {
  users: { // [][]any
  }, // [][]any
}
/**
 * @callback AdminUserCrudCallback
 * @param {AdminUserCrudOut} o
 * @returns {Promise}
 */
/**
 * @param  {AdminUserCrudIn} i
 * @param {AdminUserCrudCallback} cb
 * @returns {Promise}
 */
exports.AdminUserCrud = async function AdminUserCrud( i, cb ) {
  return await axios.post( '/admin/userList', i ).
    then( wrapOk( cb ) ).
    catch( wrapErr( cb ) )
}
