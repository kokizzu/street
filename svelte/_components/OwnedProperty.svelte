...
<div class={showMore ? 'property_more' : 'property'}>
	<div class="property_main">
		...
		<div class="property_info">
			<div class="col1">
				<div class="left">
					<div class={property.purpose === 'rent' ? `purpose label_rent` : `purpose label_sale`}>
						{property.purpose==='rent' ? translate( 'forRent' ) : translate( 'onSale' )}
					</div>
			...
			<div class="col2">
				...
				<p>{translate( 'agencyFee' )} : {property.agencyFeePercent}%</p>
				<div class="address">
	...
	<div class="property_secondary">
		<div class="feature_number">
			...
			<div class="feature_item">
				<b>{property.sizeM2 || '0'} {translate( 'm' )}2</b>
				<p>Size</p>
			</div>
		</div>
	</div>
