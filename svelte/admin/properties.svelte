    ...
    <div slot="content" >
      {#if currentPropHistory && currentPropHistory.length}
        {#each currentPropHistory as row}
          <div class="prop_item">
            <div class="row">
              <p class="name">Property ID</p><span>:</span><p class="value">{row.id}</p>
            </div>
            <div class="row">
              <p class="name">Created At</p><span>:</span><p class="value">{datetime2(row.createdAt) || '-'}</p>
            </div>
            <div class="row">
              <p class="name">Created By</p><span>:</span><p class="value">{row.createdBy}</p>
            </div>
            <div class="row">
              <p class="name">Deleted At</p><span>:</span><p class="value">{datetime2(row.deletedAt) || '-'}</p>
            </div>
            <div class="row">
              <p class="name">Updated At</p><span>:</span><p class="value">{datetime2(row.updatedAt) || '-'}</p>
            </div>
            <div class="row">
              <p class="name">Updated By</p><span>:</span><p class="value">{datetime2(row.updatedBy)}</p>
            </div>
            <div class="row">
              <p class="name">Address</p><span>:</span><p class="value">{row.address}</p>
            </div>
            <div class="row">
              <p class="name">District</p><span>:</span><p class="value">{row.district}</p>
            </div>
            <div class="row">
              <p class="name">Price</p><span>:</span><p class="value">{row.price}</p>
            </div>
            <div class="row">
              <p class="name">Price NTD</p><span>:</span><p class="value">{row.priceNtd}</p>
            </div>
            <div class="row">
              <p class="name">Price per Unit</p><span>:</span><p class="value">{row.pricePerUnit}</p>
            </div>
            <div class="row">
              <p class="name">Property Key</p><span>:</span><p class="value">{row.propertyKey}</p>
            </div>
            <div class="row">
              <p class="name">Serial Number</p><span>:</span><p class="value">{row.serialNumber}</p>
            </div>
            <div class="row">
              <p class="name">Transaction date normal</p><span>:</span><p class="value">{row.transactionDateNormal || '-'}</p>
            </div>
            <div class="row">
              <p class="name">Transaction Key</p><span>:</span><p class="value">{row.transactionKey}</p>
            </div>
            <div class="row">
              <p class="name">Transaction Number</p><span>:</span><p class="value">{row.transactionNumber}</p>
            </div>
            <div class="row">
              <p class="name">Transaction Sign</p><span>:</span><p class="value">{row.transactionSign}</p>
            </div>
            <div class="row">
              <p class="name">Transaction Time</p><span>:</span><p class="value">{datetime2(row.transactionTime)}</p>
            </div>
            <div class="row">
              <p class="name">Transaction Type</p><span>:</span><p class="value">{row.transactionType}</p>
            </div>
          </div>
        {/each}
      {:else}
